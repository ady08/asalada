...
echo $i"===================================================="
echo $i"====================+++++++++++++++================================"
echo $i"|"$me" @"$i" |"$bi"  Facebook  : Armando V Gaming" $i"|"$bi" +"$i" |"
echo $i"|"$me" @"$i" |"$me"  Youtube   : Armando Siburian" $i"|"$me" @"$i" |"
echo $i"|"$me" @"$i" |"$pu"  Instagram :@nicoleus_sitorus" $i"|"$pu" +"$i" |"
echo $i"|"$me" @"$i" |"$bi"  Thanks To : Nicoleus Sitorus" $i"|"$bi" @"$i" |"
echo $i"|"$me" @"$i" |"$me"  Thanks To : SAMOSIR CYBER TEAM" $i"|"$me" +"$i" |"
echo $i"|"$me" @"$i" |"$pu"  Facebook  : Nicoleus Sitorus" $i"|"$pu" @"$i" |"
echo $i"====================+++++++++++++++================================"
...
echo $i"===================================================="
echo $i"|"$me" 1"$i" |"$bi" BRUTEFORCE FB PHP"
echo $i"|"$me" 2"$i" |"$pu" BRUTEFORCE FB v.1"
echo $i"|"$me" 3"$i" |"$bi" BRUTEFORCE FB v.1.2"
echo $i"|"$me" 4"$i" |"$pu" BRUTEFORCE FB v.1.3"
echo $i"|"$me" 5"$i" |"$bi" BRUTEFORCE FB v.1.4"
...
echo $i"===================================================="
echo
echo $me"┌==="$bi"["$i"Nicoleus|Armando"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
