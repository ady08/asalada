...
echo $i"===================================================="
echo $i"====================+++++++++++++++================================"
echo $i"|"$me" @"$i" |"$me"  Facebook  : Armando V Gaming" $i"|"$me" +"$i" |"
echo $i"|"$me" @"$i" |"$me"  Youtube   : Armando Siburian" $i"|"$me" @"$i" |"
echo $i"|"$me" @"$i" |"$me"  Instagram :@nicoleus_sitorus" $i"|"$me" +"$i" |"
echo $i"|"$me" @"$i" |"$me"  Thanks To : Nicoleus Sitorus" $i"|"$me" @"$i" |"
echo $i"|"$me" @"$i" |"$me"  Thanks To : SAMOSIR CYBER TEAM" $i"|"$me" +"$i" |"
echo $i"|"$me" @"$i" |"$me"  Facebook  : Nicoleus Sitorus" $i"|"$me" @"$i" |"
echo $i"====================+++++++++++++++================================"
